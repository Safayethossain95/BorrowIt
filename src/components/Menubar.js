...
import MenubarButtonWithModal from './sub-components/MenubarButtonWithModal';
const Menubar = (props) => {
    ...
    <>
        ...
        <Navbar className="main_menu"  expand="lg">
            <Container>
                ...
                <MenubarButtonWithModal not={`${props.not}`} title={`${props.title}`} title2={`${props.title2}`} classname="menu_button" classname2="iconactive" />
